...
from app.constants.providers import LLM_PROVIDERS, get_embedding_models, MOCK_PROVIDER
...
def get_llm_providers():
    ...
    providers_info = [
        Provider(name=provider, embedding_models=get_embedding_models(provider))
