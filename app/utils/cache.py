...
class Cache:
    ...
    def clear_pattern(self, pattern: str) -> bool:
        ...
        try:
            ...
            logger.warning(f"Redis connection error while clearing pattern {pattern}: {e}")
            return False
        except Exception as e:
    ...
    def exists(self, key: str) -> bool:
        ...
        try:
            ...
            logger.warning(f"Redis connection error while checking existence of key {key}: {e}")
            return False
        except Exception as e:
    ...
    def ttl(self, key: str) -> Optional[int]:
        ...
        try:
            ...
            logger.warning(f"Redis connection error while getting TTL for key {key}: {e}")
            return None
        except Exception as e:
